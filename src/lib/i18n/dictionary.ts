...
export const I18N: Record<Lang, Dict> = {
  en: {
    ...
    'home.hero.tagline':
      'A private gathering place for the descendants of {root} — {g} generations, {n} names, one lineage.',
    'home.hero.expand':
    ...
    'tree.sub': 'Descendants of {root}. Click any name to see their profile.',
    ...
    'history.title': 'Family History',
    'history.sub':
      'Research, stories, and context gathered about the family — the village of Alqosh, our ancestors, and the lineage that brought us here.',
    'history.tip': 'If you have any more information to share, please email us at',
    'history.email': 'admin@kojafamily.com',
    'history.empty': 'No entries yet.',
    'history.added_by': 'Posted by',
    'history.remove': 'Remove',
    'history.remove.confirm': 'Remove this entry?',
    'history.compose': 'New history entry',
    'history.form.title': 'Title',
    'history.form.body': 'Story',
    'history.form.body.placeholder':
      'What is this about? Where did the information come from? Share as much detail as you have.',
    'history.form.photo': 'Photo (optional)',
    'history.form.save': 'Post',
    'history.form.cancel': 'Cancel',
    'history.error.forbidden': 'Only admins can post family history.',
    'history.error.not_signed_in': 'Sign in as an admin to post.',
    'history.error.bad_title': 'Give the entry a title.',
    'history.error.bad_body': 'Write something before posting.',
    'history.error.generic': 'Could not post. Please try again.',
  ...
  ar: {
    ...
    'home.hero.arabic': 'بيت كوجا',
    'home.hero.tagline':
      'مكان خاص لأبناء وأحفاد {root} — {g} أجيال، {n} اسمًا، وسلالة واحدة.',
    'home.hero.expand':
    ...
    'tree.sub': 'أبناء وأحفاد {root}. اضغط على أيّ اسم لعرض ملفّه الشخصي.',
    ...
    'history.title': 'تاريخ العائلة',
    'history.sub':
      'أبحاث وقصص وسياق حول العائلة — قرية ألقوش، أجدادنا، والسلسلة التي أوصلتنا إلى هنا.',
    'history.tip': 'إن كانت لديك معلومات إضافية، راسلنا على',
    'history.email': 'admin@kojafamily.com',
    'history.empty': 'لا توجد مشاركات بعد.',
    'history.added_by': 'نشره',
    'history.remove': 'إزالة',
    'history.remove.confirm': 'هل تريد إزالة هذه المشاركة؟',
    'history.compose': 'إضافة مشاركة تاريخية',
    'history.form.title': 'العنوان',
    'history.form.body': 'النص',
    'history.form.body.placeholder':
      'عن ماذا تتحدث هذه المشاركة؟ ومن أين وصلتك هذه المعلومات؟ شارك أكبر قدر من التفاصيل لديك.',
    'history.form.photo': 'صورة (اختياري)',
    'history.form.save': 'نشر',
    'history.form.cancel': 'إلغاء',
    'history.error.forbidden': 'النشر في التاريخ متاح للإداريّين فقط.',
    'history.error.not_signed_in': 'سجّل دخولك كإداري لتنشر.',
    'history.error.bad_title': 'أدخل عنوانًا للمشاركة.',
    'history.error.bad_body': 'اكتب نصًا قبل النشر.',
    'history.error.generic': 'تعذّر النشر. حاول مجددًا.',
    ...
    'footer.thanks': 'شكراً لفواز عادل وداود شمعون كوجا على الأبحاث التي جعلت هذا المشروع ممكناً!',
    ...
    'claimPopup.title': 'هل تحتاج إلى مساعدة للمطالبة بحسابك؟',
    'claimPopup.sub':
      'ابحث عن اسمك في شجرة العائلة — اضغط على النتيجة لفتح الملف الشخصي والمطالبة به.',
    'claimPopup.searchLabel': 'اسمك',
    'claimPopup.searchPlaceholder': 'مثال: نيكولاس فادي',
    'claimPopup.noMatches': 'لا توجد نتائج. جرّب تهجئة مختلفة أو تصفّح الشجرة.',
    'claimPopup.disclaimer':
      'قد تكون الأسماء مكتوبة بتهجئة مختلفة في الشجرة. إن لم تجد اسمك، تصفّح الشجرة كاملةً أو اطلب الإضافة إن لم تكن موجودًا.',
    'claimPopup.treeCta': 'تصفّح الشجرة',
    'claimPopup.requestCta': 'اطلب الإضافة',
    'claimPopup.close': 'إغلاق',
    'claimPopup.backToSearch': 'العودة للبحث',
